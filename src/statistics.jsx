...
const Statistics = ({ selectedMonth }) => {
  ...
  return (
    <div className="pb-5">
      <div className="flex font-bold text-black text-2xl m-5">
      ...
      <div className="flex m-5">
        <div className="container max-w-max p-4 bg-[#f8df8c] rounded-xl">
          <div className="flex flex-row flex-wrap gap-5">
            <div>
              <h3 className="font-700">Total Sale Amount:</h3>
              <h3 className="font-700">Total Sold Items:</h3>
              <h3 className="font-700">Total Not Sold Items:</h3>
            </div>
            <div>
              <h3 className="font-bold text-black">{statistics.totalSaleAmount}</h3>
